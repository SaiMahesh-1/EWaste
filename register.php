...
if(isset($_POST['regs']))
{
    ...
    if(empty($fname)|| empty($lname)|| empty($email)|| empty($ph)|| empty($pass))
    {
        ...
        $sql="insert into users (FNAME,LNAME,EMAIL,PHONE_NUMBER,PASSWORD) values('$fname','$lname','$email',$ph,'$Pass')";
...
?>
  ...
  <style>
      body{
        background-image:  linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url("https://assets.weforum.org/article/image/responsive_big_webp_l1vguMtlhr-HUreEHdnQRiQaJc9upzgW3WdePYEKL84.webp");
        background-size: 100%;
...
<center>
    ...
    <button id="back"><a href="EWASTE project.html">HOME</a></button>
    <h1 id="fam">Join the Movement, Register on our E-Waste Website Today!</h1>
 <div class="main">
        ...
        <form id="register" action="register.php" method="POST">    
          ...
          <br><br>
            ...
            <input type="submit" class="btnn"  value="REGISTER" name="regs" style="background-color: rgb(121, 50, 50);color: white">
